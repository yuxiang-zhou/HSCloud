 ...
 <?php  if(!empty($goods)) { ?>
	...
	<div class="info">
    	<div class="title">
            ...
            <div class="text">如何分享</div>
        </div>
        <div class="con">
          <div class="line">
           	<div class="t1">第一步</div>
                <div class="t2">
                	<div class="t3">转发如上链接或图片给微信好友；</div>
                </div>
          </div>
          <div class="line">
           	<div class="t1">第二步</div>
                <div class="t2">
                	<div class="t3">从您转发的链接或图片进入天香赋的好友，<?php  if($this->set['become_child']==1) { ?>如果您的好友下单，<?php  } ?><?php  if($this->set['become_child']==2) { ?>如果您的好友下单并付款，<?php  } ?>系统将自动锁定成为您的香粉, 他们在微信商城中购买任何商品，您都可以获得<?php  echo $this->set['texts']['commission1']?>；</div>
                </div>
          </div>
          <div class="line">
        ...
        <div class="info2">说明：分享后会带有独有的推荐码，您的好友访问之后，系统会自动检测并记录客户关系。如果您的好友已被其他人抢先发展成了香粉，他就不能成为您的香粉，以最早发展成为香粉为准。</div>
	</div>
