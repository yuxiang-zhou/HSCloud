...
<script id='tpl_main' type='text/html'>
    ...
    <div class="menu">  
        ...
        <a href="<?php  echo $this->createPluginMobileUrl('commission/myshop/set')?>"><div class="nav nav1"><i class="fa fa-cog  fa-3x" style="color:#aadaf6;"></i><div class="title">粉苑设置</div><div class="con">设置我的粉苑</div></div></a>
		<%if set.openselect%>
