...
<script id='tpl_main' type='text/html'>
 ...
 <div class="myshop_main" >
     ...
     <input type="hidden" id="img1" />
        <div class="line"><div class="label">粉苑名称</div><div class="info"><div class="inner"><input type="text" id="shopname" value="<%shop.name%>"/></div></div></div>
        <div class="line1"><div class="label">粉苑头像</div><div class="info"><div class="inner">
        ...
        <div class="line1"><div class="label">粉苑店招</div><div class="info"><div class="inner">
        ...
        <div class="line2"><textarea id="desc" placeholder="粉苑简介,分享你的粉苑"><%shop.desc%></textarea></div>
    </div>
