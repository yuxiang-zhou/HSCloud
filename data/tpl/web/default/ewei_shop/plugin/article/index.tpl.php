...
<div class='panel panel-default'>
    <div class='panel-heading'> 文章列表 <?php  if($articlenum) { ?>(总数: <?php  echo $articlenum;?>)<?php  } ?> <small>排序数字越大越靠前</small></div>
    <div class='panel-body'>
        <table class="table" >
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;">文章关键字</th>
                    <th style="text-align: center;">文章创建时间</th>
                    <th style="text-align: center;">真实阅读量</th>
            ...
            <tbody>
			 ...
			 <a href="javascript:;" data-url="<?php  echo $this->createPluginMobileUrl('article',array('aid'=>$article['id']))?>" class="js-clip btn btn-default" title="复制链接"><i class='fa fa-link'></i></a>	   
			 <a href="<?php  echo $this->createPluginMobileUrl('article',array('aid'=>$article['id'],'preview'=>1))?>" target='_blank' class="btn btn-default" title="预览"><i class='fa fa-search'></i></a>	   
                                <?php if(cv('article.page.edit')) { ?>
...
//初始化百度编辑器结束
    ...
    $("#nav-save").click(function(){
            ...
            $(".judge").each(function(){
						...
						if(!$(this).val()){ Tip.show($(this),'此项不能为空!',"top");
							$("#nav-step-2").click();
...
<div class="fart-main">
    ...
    <div class="fart-editor">
                    ...
                    <div class="line">
                        <div class="line2" style="margin-right: 10px;">
                            <div class="input-group form-group">
                                ...
                                <input type="number" name="article_readnum_v" class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_readnum_v'];?><?php  } ?>" placeholder="页面阅读量 = 真实阅读量 + 虚拟阅读量" bind-in="art_read" bind-de="100000+">
                            </div>
                        </div>
                        <div class="line2">
                            <div class="input-group form-group">
                                <span class="input-group-addon">虚拟点赞数</span>
                                <input type="number" name="article_likenum_v" class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_likenum_v'];?><?php  } ?>" placeholder="页面点赞数 = 真实点赞数 + 虚拟阅读数" bind-in="art_like" bind-de="54321">
                            </div>
                        </div>
                    </div>
                    <div class="line">
                    ...
                    <div class="line">
                       <div class="line2" style="margin-right: 10px;" >
                            <div class="input-group form-group">
                                ...
                                <input type="text" name="article_rule_daynum"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_daynum'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon" style="border-left: 0px; border-right: 0px;">次&nbsp;&nbsp;每人总共奖励</span>
                                <input type="text" name="article_rule_allnum"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_allnum'];?><?php  } ?>" placeholder="0">
			 ...
			 <div class="line2" >
                            <div class="input-group form-group">
                                <span class="input-group-addon">
									<label class='checkbox checkbox-inline' style='margin-top:2px;'>
										<input type='checkbox' name='article_hasendtime' <?php  if($artice['article_hasendtime']==1) { ?>checked<?php  } ?> /> 奖励到期时间
									</label>
									</span>
                                   <?php  echo tpl_form_field_date('article_endtime',$article['article_endtime'],true)?>
                            </div>
                        </div>
		...
		<div class="line">
			<div class="line2" style="margin-right: 10px;">
                            <div class="input-group form-group">
                                <span class="input-group-addon" style="border-right: 0px;">阅读区域限制</span> 
                                <input type="text" name="article_areas"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_areas'];?><?php  } ?>" placeholder="省份或城市，多个用半角逗号隔开">
                            </div>
                           ...
                           <div class="line2" >
							<div class="input-group form-group">
                                <span class="input-group-addon" style="border-right: 0px;">每人最多记录</span> 
                                <input type="text" name="article_readtime"  class="form-control judge" value="<?php  if($aid) { ?><?php  echo $article['article_readtime'];?><?php  } else { ?>4<?php  } ?>" placeholder="最多记录次数，默认 4 次">
						<span class="input-group-addon" style="border-right: 0px;">次</span> 
                            </div>
		       </div>
		</div>
						 ...
						 <div class="line">
                            ...
                            <div class="input-group form-group">
                                <span class="input-group-addon">奖励积分上限</span>
                                <input type="text" name="article_rule_credittotal"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_credittotal'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon" style="border-left: 0px; border-right: 0px;">个积分 剩余</span>
                                <input type="text" class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_creditlast'];?><?php  } ?>" readonly>
                                <span class="input-group-addon" style="border-left: 0px;">积分 实际剩余</span>
			  <input type="text" class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_creditreallast'];?><?php  } ?>" readonly>
			  <span class="input-group-addon" style="border-left: 0px;">积分</span>
                            </div>
                           
                        </div>
                        <div class="line ">
                             <div class="input-group form-group">
                                <span class="input-group-addon">奖励余额上限</span>
                                <input type="text" name="article_rule_moneytotal"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_moneytotal'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon" style="border-left: 0px; border-right: 0px;">元余额 剩余</span>
                                <input type="text" class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_moneylast'];?><?php  } ?>" readonly>
                                <span class="input-group-addon" style="border-left: 0px;">元 实际剩余</span>
			  <input type="text" class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_moneyreallast'];?><?php  } ?>" readonly>
			  <span class="input-group-addon" style="border-left: 0px;">元</span>
                            </div>
                           <span class='help-block'>奖励规则上限空或0时无限发放;  </span>
						
                        </div>
              <span class="help-block">计算公示：剩余   = 总数- 首次阅读减少  *（ 首次阅读数 + 虚拟阅读数） - 重复阅读减少 * 重复阅读数</span>
						   <span class="help-block">计算公示：实际剩余   = 总数- 首次阅读奖励  * 首次阅读数 - 重复阅读奖励 * 重复阅读数</span>
						   <span class="help-block">剩余为0或小于奖励设定时，不再发放奖励</span>
		 <div class="line">
                        
                               <div class="line2" style="margin-right: 10px;">
                            <div class="input-group form-group">
                                <span class="input-group-addon" style="border-right: 0px;">分享首次点击获得</span> 
                                <input type="text" name="article_rule_credit"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_credit'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon" style="border-left: 0px; border-right: 0px;">个积分</span> 
                                <input type="text" name="article_rule_money"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_money'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon">元余额</span> 
                            </div>
                        </div>
		   <div class="line2">
                            <div class="input-group form-group">
                                <span class="input-group-addon" style="border-right: 0px;">分享首次点击减少</span> 
                                <input type="text" name="article_rule_creditm"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_creditm'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon" style="border-left: 0px; border-right: 0px;">个积分</span> 
                                <input type="text" name="article_rule_moneym"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_moneym'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon">元余额</span> 
                            </div>
                        </div>
		 ...
		 <div class="line">
                               ...
                               <div class="line2" style="margin-right: 10px;">
                            <div class="input-group form-group">
                                <span class="input-group-addon" style="border-right: 0px;">分享重复点击获得</span> 
                                <input type="text" name="article_rule_credit2"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_credit2'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon" style="border-left: 0px; border-right: 0px;">个积分</span> 
                                <input type="text" name="article_rule_money2"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_money2'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon">元余额</span> 
		   ...
		   <div class="line2">
                            <div class="input-group form-group">
                                <span class="input-group-addon" style="border-right: 0px;">分享重复点击减少</span> 
                                <input type="text" name="article_rule_creditm2"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_creditm2'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon" style="border-left: 0px; border-right: 0px;">个积分</span> 
                                <input type="text" name="article_rule_moneym2"  class="form-control" value="<?php  if($aid) { ?><?php  echo $article['article_rule_moneym2'];?><?php  } ?>" placeholder="0">
                                <span class="input-group-addon">元余额</span> 
                            </div>
                        </div>
            ...
            <div class="fart-editor-content" step="1" style="display: block;">
                ...
                <div class="content">
                    <div class="con1">
			 <script id=editor style="width:100%;height:100%;"><?php  echo htmlspecialchars_decode($article['article_content'])?></script>
			</div>
                    ...
                    <div class="con2">
                        ...
                        <div id="tabcon">
                            ...
                            <div n="4" class="con">
                                <div class="itembox" title="点击蓝字加关注"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3YMVZq8vPMnMiaKsDVFDZcic4g2U3sBaNxBiaIicoLB6QvWhrz8fU0Aay3w/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="点击蓝字加关注"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3YfT9k626AtJ5ggI2VUqRBsDaMzOE8Y7OGjfGcnKu92vy959voCWc0g/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="点击蓝字加关注"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3t1CsHDz13B4iaUgncMnJNUFngThmB8iaV7o7WZ5q7QraAk58fBatf3hw/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="点击蓝字加关注"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/DCE5nxPSl5QEJxRJI0dvChhaicNhf7LfFAPv4NxBgy8MxXxJKFUoS4R2iaV7fSUjUmZuGbKyDqRzMZQVJSesibHTg/0?wx_fmt=jpeg"></p></div>
                                <div class="itembox" title="差一点我们就擦肩而过了"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq34QZrusKq3oL67icn9F8kGEIdMzjWH0icEyYm7PjmWlCPsC5FftF7BB9g/0?wx_fmt=png"></p></div>
                                <div class="itembox" title="点击蓝字加关注"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3qNJDzspGItOoP9IVUBYWUX25KIFsuo9EzHRgOZticVbSuKK6KO7jMsA/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="点击蓝字加关注"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3my2ob9d9icNmM4J4sicuibTdicicJeeTwSVvC0mRa2aHUoIrrKPZF62CVVw/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="点击蓝字加关注-蜡笔小新"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3e1m8oD3XKSciaWrCjJt3JMKQTkLPiaKibvfpOuwlImdvIssicIqYaXKVicw/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="点击蓝字加关注-流浪兔"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3rnowrN26pp5piaZruxPibVvmRxuAtibGAtmVG5g0ticiaA9jJDSMh51Xjpg/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="gif手指"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3m6RmtLIMyjYZwhZQrMnJkiaVCiauUlq0icQYCLhgNXaLYMdr7IatKCiaBg/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="加关注你懂的"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq38Ya0Eu0LiaS8yzQ9ZibQ62RDx8iazMy1kpviaibaGlD9HXBrAcg5XtK4Vog/0?wx_fmt=jpeg"></p></div>
                                <div class="itembox" title="长按识别图中二维码"><section style="margin: 5px auto;white-space: normal;"><blockquote style="margin:0 auto;width:360px;border:none #ff8124;box-sizing:border-box;background-image:url(http://mmbiz.qlogo.cn/mmbiz/buNzDicETA2lEDXPPWQ02ibNweHZzeqmcAUz5Kycmhga9FSvHX0zpWqiaFFrytUzBibvbaoViaOPNe7KGugBGsiakOwA/0);background-position:right 0;background-size:contain;background-repeat:no-repeat"><section style="padding:10px 3px"><img style="max-width:50%!important" src="../addons/ewei_shop/plugin/article/template/imgsrc/itembox/0003.jpg" data-width="150px" width="150" border="0" vspace="0" title="" alt=""></section></blockquote></section></div>
                                ...
                                <div class="itembox" title="举牌二维码"><section style="margin: 5px auto;white-space: normal;"><blockquote style="max-width:100%;padding:5px 15px;border:none #ff8124;word-wrap:break-word!important;box-sizing:border-box!important;background-size:contain;background-position:50% 50%;background-repeat:no-repeat;background-image:url(http://mmbiz.qlogo.cn/mmbiz/aTgmCo8cA2FHQQDwzTZJ0SY5BlJ740B4ia60XHTNaF1wNJVrjD3aNkJDJRjW4wxsYXGia5yCpAHqxATFfu3StYicg/0)"><section><p><br></p><section style="border:0;margin:0 -1px;box-sizing:border-box;width:100%;clear:both;padding:0" data-width="100%"><section style="margin:0 auto;width:130px;height:130px;box-sizing:border-box;text-align:center" data-width="130px"><img style="width:120px;height:120px" src="../addons/ewei_shop/plugin/article/template/imgsrc/itembox/0003.jpg" width="120" height="120" border="0" vspace="0" title="" alt=""></section></section></section><p style="text-align:center"><span style="font-size:12px;line-height:21px;text-align:justify;text-decoration:underline;text-indent:28px;white-space:pre-wrap">长按上图，识别二维码关注</span></p><p style="text-align:center"><span style="font-size:12px;line-height:21px;text-align:justify;text-indent:28px;white-space:pre-wrap">一更多精彩一</span></p><p><br></p><p><br></p><p><br></p><p><br></p></blockquote></section></div>
                                <p style="text-align:center; line-height:30px; color:#999;">没有更多啦...</p>
                            </div>
                            <div n="5" class="con">
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPjhXdiaw8ibquYYw8MI1InGKpUJlXdAuAicDHKWuf1sXQEwticoDZ5T5Q0yicjIJyrBCHktl1JHX2DCJLg/0/mmbizgif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPjhXdiaw8ibquYYw8MI1InGKpr6JV7kJAvBybMCebbQbMh7ZLL2GMGPTV9KhMcwJOMHIkyDibyJsTIhA/0/mmbizgif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPjhXdiaw8ibquYYw8MI1InGKpF17tUGszhvf58vVQTZjfpzD1icTlNCcz4ibTFjhST44tH0dYQpagg5ag/0/mmbizgif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPhuxibIOsThcH7HF1lpQ0YvkYedyfd5kNTYhg6ZcVyV0J6M2N6lYlueToTr0ebAzibPibn8I8v3Qiandw/0/mmbizgif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPjhXdiaw8ibquYYw8MI1InGKpNkaSe1ryqXSFkphB7EQLFT34NHCA4oQPh4QrJdNvQS11MiatXLV2CDQ/0/mmbizgif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/yqVAqoZvDibFmpaG1bHyLIFpk6h6SygXFmcfFdC6hYdLWyF4byicIc9ia7OzuUnOoN2PzTrCn8ILN9YmI11pQZOicQ/0?wx_fmt=jpeg"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPhuxibIOsThcH7HF1lpQ0YvkUeBWCIdSiamRg8cFeYM8zl7TrvI2X7tsGhOpb2y56aFJwYibiaqUxeDNg/0/mmbizgif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPhuxibIOsThcH7HF1lpQ0YvkicGBV51TmkSCfh6T9DmLKx7v6tXmulYESt4kdEUWNOW0eW6N82zCqYg/0/mmbizgif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPiaB5wTN4rt8SiaLwWPOGjzszGdVn0IBuhK3YdplBpxYKRFzCKicnWRZFVMdkLw1gMv8Rcuy1vNJEXNA/0"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPia3RFX6Mvw06kePJ7HbmI7bibbbzG3uqZ8S8QicFSnqobkGSPq4X5D9btObvy1zy6EyibLlplicicszCSg/0?wx_fmt=png"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQudCxhicVdD2GDlvfZSnCRbKEdic5ul1RvXMG9zRZNZPlXsdMktH471NSlpg0iccTcfvc7uMFUwRHibcCw/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3qiaEPlAYy8iaicRvzj1icRvFyaxwhN92gj1VGP4DIsZ71DVzEmGKehM21g/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3icp0qCHwh8WL0G1YPib8Eibqxibbnudk4sgnjqBuoj7ciaiaofV3uTg0vJyA/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3iajxh0aTgUk4bmsNZjsiamJSTWazjrpCgtObspbwURLpDP8cegpwVTjA/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3fB0biaicZUwG4RWvgwy8CHAlibicomftPwiazq2lz0o9dbMLXBsrfUmBnmg/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3UYok4TTGsyQRoWZkuqWHUmNib7OE1sBTMoTdEoNcJ45BZeg2robQnSQ/0?wx_fmt=jpeg"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3RfygZYDWf0nFNib5iclyRs7M7xiaSicvibPxz8toENPH9dia1ZlYPYrm5UNQ/0?wx_fmt=jpeg"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/jZlB3L4cckX0gAhfFZrBHHODjVdTtCnw4ErS97dmE14s1d4D2WypOjA8MTKJrRCcLXSosibh5bUbZUibP2uHRwyQ/0"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/6xsuhALdNEr0ibLDATPbiaQoI0OyJzZP813MfewdMGP0CRRUqTgCGJO4tKibZJLcrVESQxnmTNDFSzuTCnVjV6iaxw/0"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/6xsuhALdNEr0ibLDATPbiaQoI0OyJzZP81jDYTckoPrfeX088lekl55f4B43DyAGgGfvtCXmEmg8KtLjtQ7yMLiaw/0"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/6xsuhALdNEr0ibLDATPbiaQoI0OyJzZP81KAjkO1amv78GtEQkLiag8ibQ7NibgTdnj0tUpmhMo2DsYvZkLAQzH8edw/0"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/6xsuhALdNEr0ibLDATPbiaQoI0OyJzZP81jUpsBzUCDBCf1wr2YyIhQoqRTQ8D5ArKPDE0ZFSdicuP8ug1LJcbokA/0"></p></div>
                                <div class="itembox" title="普通分割线样式"><p><img width="100%" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3V9snSZ9J0LPay4mY55B8JIPHZ1ib2QE3fmufRBKb0I2ORdW5uD1EShA/0?wx_fmt=png"></p></div>
                                <p style="text-align:center; line-height:30px; color:#999;">没有更多啦...</p>
                            </div>
                            <div n="6" class="con">
                                ...
                                <div class="itembox" title="卡通猛戳"><p><img style="height: auto !important;" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3XG6TtnvtgiaJQIfog0be4o0SYAIDAMSQtnnXfm8rP1AFBY4kadMLdibg/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="卡通点这"><p><img style="height: auto !important;" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3eDrpBicLicv1gBF89W3klKic1D1wxgxZb9a22MxQRttBw03jYf30Yic17g/0?wx_fmt=gif"></p></div>
                                <div class="itembox" title="99%的人点击了阅读原文"><p><img style="height: auto !important;" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufaFonP5uahBudGuINbPKsALeKOvnhykkEIjOu3oMBk4diadMKEDQayIcNjPFwPlDSgGa8DcAE8EVQ/0?wx_fmt=gif"></p></div>
                                <p style="text-align:center; line-height:30px; color:#999;">没有更多啦...</p>
                            </div>
                            <div n="7" class="con">
                                <div class="itembox" title="对话框左"><section><section style="text-align: left;"><img style="vertical-align: top; width: 40px;" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq31pvIqv5RLcdOw2A6Kj0JN0uaUH6TJbVJSa4L2YMtljNVaUdlzkaJqA/0?wx_fmt=png"><img style="vertical-align: top; margin-top: 1.8em;" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3MORYLSvWXHib8vkfbs3CKKquxureFEUTnqS5fSFdx7Pgss3vIjjwvGQ/0?wx_fmt=png"><section style="display: inline-block; width: 40%; margin-top: 0.7em; margin-left: -0.4em; padding: 1em; background-color: #ffe4c8; border-radius: 1em;"><p>请输入对话</p></section></section></section></div>
                                <div class="itembox" title="对话框右"><section><section style="text-align: right;"><section style="display: inline-block; width: 40%; margin-top: 0.7em; margin-right: -0.4em; padding: 1em; background-color: #bce3f9; border-radius: 1em; text-align: left;"><p>请输入对话</p></section><img style="vertical-align: top; margin-top: 1.8em;" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3Kslkc89QvoG0l55hTd2iaThbhOibq8v62hfFfMzlBDhqWPsqnVQw7lGA/0?wx_fmt=png"><img style="vertical-align: top; width: 40px;" src="http://mmbiz.qlogo.cn/mmbiz/h1VV7TJtQufpoja8icV1RNvaDQ7ZryBq3HRcrSD65J3w4nuOAydqCQCXeUWqrNmqKuN3WUaIZhl1ib91LT7ShgpQ/0?wx_fmt=png"></section></section></div>
    ...
    <div class='panel-body'>
        <div class="form-group" style="padding-top:20px;">
		   ...
		   <div class="form-group"  style="position:relative">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">文章列表直接链接(点击连接复制)</label>
                <div class="col-sm-9 col-xs-12">
                    <p class='form-control-static'><a href='javascript:;' title='点击复制连接' data-url="<?php  echo $this->createPluginMobileUrl('article/article')?>" class="js-clip"><?php  echo $this->createPluginMobileUrl('article/article')?></a> </p>
                </div>
            </div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="alert alert-info">
            ...
            <p>触发关键字：<?php  echo $article['article_keyword'];?></p>
            <p>创建时间：<?php  echo $article['article_date'];?></p>
            <p>阅读量：<?php  echo intval($allreads)+$article['article_readnum_v']?></p>
            <p>点赞数：<?php  echo intval($article['article_likenum_v'])+intval($article['article_likenum'])?></p>
            <p>积分累计发放数量：<?php  echo $add_credit1;?> 积分</p>
            <p>余额累计发放数量：<?php  echo $add_money1;?> 元</p> 
        </div>
		
	 <div class="alert alert-info">
            <p>阅读量(真实+虚拟=总数)：<?php  echo intval($article['article_readnum'])?> + <?php  echo intval($article['article_readnum_v'])?> = <?php  echo intval($article['article_readnum_v'])+intval($article['article_readnum'])?></p>
            <p>点赞数(真实+虚拟=总数)：<?php  echo intval($article['article_likenum'])?> + <?php  echo intval($article['article_likenum_v'])?> = <?php  echo intval($article['article_likenum_v'])+intval($article['article_likenum'])?></p>
            <p>积分实际发放数量：<?php  echo $add_credit;?> 积分</p>
            <p>余额实际发放数量：<?php  echo $add_money;?> 元</p> 
        </div>
