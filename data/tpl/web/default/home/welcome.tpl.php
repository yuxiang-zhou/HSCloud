...
<div class="clearfix welcome-container">
	<?php  if($do != 'ext' && $do != 'members' &&  $do != 'fournet') { ?>
	...
	<?php  } ?>
	<?php  if($do == 'members') { ?>
	<?php (!empty($this) && $this instanceof WeModuleSite || 0) ? (include $this->template('home/welcome-members', TEMPLATE_INCLUDEPATH)) : (include template('home/welcome-members', TEMPLATE_INCLUDEPATH));?>
	<?php  } ?>
