...
<div class="clearfix">
	...
	<form action="" method="post"  class="form-horizontal" role="form" enctype="multipart/form-data" id="form1">
		...
		<?php  if($_W['setting']['platform']['authstate']) { ?>
		<div class="alert alert-danger">
			获取公众号信息功能极不稳定，建议您使用<a  class="btn btn-success" style="margin-left:5px;" href="<?php  echo $authurl;?>"><i class="fa fa-weixin"></i> 授权登录添加公众号</a>，或是跳过此步，手动添加
		</div>
		<?php  } ?>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<p class="form-control-static">在微信公众号请求用户网页授权之前，开发者需要先到公众平台网站的【开发者中心】<b>网页服务</b>中配置授权回调域名。<?php  if($_W['isfounder']) { ?><a href="http://www.012wz.com/wiki" target="_black">查看详情</a><?php  } ?></p>
					</div>
				</div>
				<?php  if(!empty($acid)) { ?>
					<div class="form-group">
