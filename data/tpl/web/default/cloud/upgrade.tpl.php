...
<ul class="nav nav-tabs">
	<li<?php  if($do == 'upgrade') { ?> class="active"<?php  } ?>><a href="<?php  echo url('cloud/upgrade');?>">系统更新</a></li>
	<?php  if($do == 'shipping') { ?><li class="active"><a href="javscript:;">升级处理</a></li><?php  } ?>
	<li<?php  if($do == 'bak') { ?> class="active"<?php  } ?>><a onclick="return confirm('确定将该系统框架回滚至上一次更新系统之前的版本？'); return false;" href="<?php  echo url('cloud/upgrade/bak');?>">回滚至上一版本</a></li>
</ul>
<div class="clearfix">
	<div id="tips" style="display:block; overflow:hidden;">
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="alert alert-info refresh-log">
					<h4><i class="fa fa-refresh"></i> 系统公告</h4>
					<ul class="list-unstyled">
