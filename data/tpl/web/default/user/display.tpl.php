	...
	<table class="table table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<?php  } else if($usergroups[$user['groupid']]) { ?>
				...
				<td>
					<a class="btn btn-default btn-sm" href="<?php  echo url('shop/mrecord/paylist',array('uid'=>$user['uid']))?>" title="充值记录"><i class="fa fa-share"></i>充值记录</a>

                    <a class="btn btn-default btn-sm" href="<?php  echo url('shop/mrecord/modlist',array('uid'=>$user['uid']))?>" title="消费记录"><i class="fa fa-share"></i>消费记录</a>
				</td>
				<?php  if($_W['isfounder']) { ?>
				<td>
					<div>
				...
				<td>
					<div>
						<a href="<?php  echo url('user/sq',array('uid'=>$user['uid']))?>">授权</a>
					</div>
				</td>
				<?php  if($_W['isfounder']) { ?>
				<td>
