...
.head{height:40px; line-height:40px; background:#E98283; padding:0 5px; color:#FFF;}
...
.head .order{background:#f3b1b2; position:absolute; z-index:9999; right:0;}
...
.head .order li.fa-caret-up{font-size:20px;color:#f3b1b2;position:absolute;top:-11px;right:16px;}
