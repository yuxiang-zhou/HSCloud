...
#activity-detail .page-topad{padding:10px;border-bottom: 1px dotted #CCC;}
#activity-detail .page-footerad{padding:10px;border-top: 1px dotted #CCC;}
...
.head{height:40px; line-height:40px; background:#428bca; padding:0 5px; color:#FFF;}
...
.head .bn.pull-right{position:absolute; right:5px; top:0; border-left:1px solid #fff;}
...
.left{padding:15px 10px 15px 10px;}
.right{float:right; display:inline-block; background:#428bca; border-radius: 4px; color:#FFF; height:25px; line-height:25px; padding:0 10px; margin-left:10px;}
</style>
<div class="head">
...
<?php  if(!empty($topad)) { ?>
<div class="page-topad">
<img src="<?php  echo toimage($topad)?>" style="width:100%;">
</div>
<?php  } ?>
...
<div class="left">
 <span style="color:#607FA6;font-size:14px;">
 <a href="<?php  echo $subscribeurl;?>" title="" target="_blank">阅读原文</a></span> &nbsp;&nbsp;
  <span style="color:#8C8C8C;font-size:14px;"> 阅读:<span class="hits orange01"><?php  echo $detail['click'];?></span>次 &nbsp;&nbsp;
<span class="right" onclick="$('#mcover').show()"><i class="fa fa-share-alt"></i> 转发</span>
<span class="right" onclick="$('#mcover').show()"><i class="fa fa-group"></i> 分享</span>
</div>
<div id="mcover" onclick="$(this).hide()"><img src="./resource/images/guide.png"></div>
<?php  if(!empty($footad)) { ?>
<div class="page-footerad">
<img src="<?php  echo toimage($footad)?>" style="width:100%;">
</div>
<?php  } ?>
