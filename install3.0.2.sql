...
DROP TABLE IF EXISTS `hs_ewei_message_mass_sign`;
CREATE TABLE `hs_ewei_message_mass_sign` (
...
DROP TABLE IF EXISTS `hs_ewei_message_mass_task`;
CREATE TABLE `hs_ewei_message_mass_task` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_message_mass_template`;
CREATE TABLE `hs_ewei_message_mass_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_abonus_bill`;
CREATE TABLE `hs_ewei_shop_abonus_bill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_abonus_billo`;
CREATE TABLE `hs_ewei_shop_abonus_billo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_abonus_billp`;
CREATE TABLE `hs_ewei_shop_abonus_billp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_abonus_level`;
CREATE TABLE `hs_ewei_shop_abonus_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_adv`;
CREATE TABLE `hs_ewei_shop_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_area_config`;
CREATE TABLE `hs_ewei_shop_area_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_article`;
CREATE TABLE `hs_ewei_shop_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_article_category`;
CREATE TABLE `hs_ewei_shop_article_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_article_log`;
CREATE TABLE `hs_ewei_shop_article_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_article_report`;
CREATE TABLE `hs_ewei_shop_article_report` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_article_share`;
CREATE TABLE `hs_ewei_shop_article_share` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_article_sys`;
CREATE TABLE `hs_ewei_shop_article_sys` (
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_author_bill`;
CREATE TABLE `hs_ewei_shop_author_bill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billno` varchar(100) DEFAULT '',
  `paytype` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_author_billo`;
CREATE TABLE `hs_ewei_shop_author_billo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_author_billp`;
CREATE TABLE `hs_ewei_shop_author_billp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_author_level`;
CREATE TABLE `hs_ewei_shop_author_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `levelname` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_author_team`;
CREATE TABLE `hs_ewei_shop_author_team` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_author_team_pay`;
CREATE TABLE `hs_ewei_shop_author_team_pay` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_banner`;
CREATE TABLE `hs_ewei_shop_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_bargain_account`;
CREATE TABLE `hs_ewei_shop_bargain_account` (
  `id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_bargain_actor`;
CREATE TABLE `hs_ewei_shop_bargain_actor` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_bargain_goods`;
CREATE TABLE `hs_ewei_shop_bargain_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_bargain_record`;
CREATE TABLE `hs_ewei_shop_bargain_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_carrier`;
CREATE TABLE `hs_ewei_shop_carrier` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_cashier_category`;
CREATE TABLE `hs_ewei_shop_cashier_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_cashier_clearing`;
CREATE TABLE `hs_ewei_shop_cashier_clearing` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_cashier_goods`;
CREATE TABLE `hs_ewei_shop_cashier_goods` (
...
DROP TABLE IF EXISTS `hs_ewei_shop_cashier_goods_category`;
CREATE TABLE `hs_ewei_shop_cashier_goods_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `cashierid` int(11) DEFAULT '0',
  `catename` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_cashier_operator`;
CREATE TABLE `hs_ewei_shop_cashier_operator` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `cashierid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_cashier_order`;
CREATE TABLE `hs_ewei_shop_cashier_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_cashier_pay_log`;
CREATE TABLE `hs_ewei_shop_cashier_pay_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `cashierid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_cashier_pay_log_goods`;
CREATE TABLE `hs_ewei_shop_cashier_pay_log_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cashierid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_cashier_qrcode`;
CREATE TABLE `hs_ewei_shop_cashier_qrcode` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `cashierid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_cashier_user`;
CREATE TABLE `hs_ewei_shop_cashier_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_category`;
CREATE TABLE `hs_ewei_shop_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_commission_apply`;
CREATE TABLE `hs_ewei_shop_commission_apply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_commission_bank`;
CREATE TABLE `hs_ewei_shop_commission_bank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_commission_clickcount`;
CREATE TABLE `hs_ewei_shop_commission_clickcount` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_commission_level`;
CREATE TABLE `hs_ewei_shop_commission_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `levelname` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_commission_log`;
CREATE TABLE `hs_ewei_shop_commission_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_commission_rank`;
CREATE TABLE `hs_ewei_shop_commission_rank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_commission_repurchase`;
CREATE TABLE `hs_ewei_shop_commission_repurchase` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_commission_shop`;
CREATE TABLE `hs_ewei_shop_commission_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `mid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_coupon`;
CREATE TABLE `hs_ewei_shop_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_coupon_category`;
CREATE TABLE `hs_ewei_shop_coupon_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
  `displayorder` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_coupon_data`;
CREATE TABLE `hs_ewei_shop_coupon_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_coupon_goodsendtask`;
CREATE TABLE `hs_ewei_shop_coupon_goodsendtask` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_coupon_guess`;
CREATE TABLE `hs_ewei_shop_coupon_guess` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `couponid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_coupon_log`;
CREATE TABLE `hs_ewei_shop_coupon_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `logno` varchar(255) DEFAULT '',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_coupon_sendshow`;
CREATE TABLE `hs_ewei_shop_coupon_sendshow` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_coupon_sendtasks`;
CREATE TABLE `hs_ewei_shop_coupon_sendtasks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
  `enough` decimal(10,2) DEFAULT '0.00',
  `couponid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_coupon_taskdata`;
CREATE TABLE `hs_ewei_shop_coupon_taskdata` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
  `openid` varchar(50) DEFAULT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_coupon_usesendtasks`;
CREATE TABLE `hs_ewei_shop_coupon_usesendtasks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_displayorder` (`couponid`),
  KEY `idx_status` (`starttime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
DROP TABLE IF EXISTS `hs_ewei_shop_creditshop_adv`;
CREATE TABLE `hs_ewei_shop_creditshop_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_creditshop_category`;
CREATE TABLE `hs_ewei_shop_creditshop_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `thumb` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_creditshop_comment`;
CREATE TABLE `hs_ewei_shop_creditshop_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_creditshop_goods`;
CREATE TABLE `hs_ewei_shop_creditshop_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_creditshop_log`;
CREATE TABLE `hs_ewei_shop_creditshop_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `logno` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_creditshop_option`;
CREATE TABLE `hs_ewei_shop_creditshop_option` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_creditshop_spec`;
CREATE TABLE `hs_ewei_shop_creditshop_spec` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_creditshop_spec_item`;
CREATE TABLE `hs_ewei_shop_creditshop_spec_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_creditshop_verify`;
CREATE TABLE `hs_ewei_shop_creditshop_verify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_customer`;
CREATE TABLE `hs_ewei_shop_customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_customer_category`;
CREATE TABLE `hs_ewei_shop_customer_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `hs_ewei_shop_customer_guestbook`;
CREATE TABLE `hs_ewei_shop_customer_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_customer_robot`;
CREATE TABLE `hs_ewei_shop_customer_robot` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `cate` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_designer`;
CREATE TABLE `hs_ewei_shop_designer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_designer_menu`;
CREATE TABLE `hs_ewei_shop_designer_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_dispatch`;
CREATE TABLE `hs_ewei_shop_dispatch` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_diyform_category`;
CREATE TABLE `hs_ewei_shop_diyform_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `hs_ewei_shop_diyform_data`;
CREATE TABLE `hs_ewei_shop_diyform_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_diyform_temp`;
CREATE TABLE `hs_ewei_shop_diyform_temp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_diyform_type`;
CREATE TABLE `hs_ewei_shop_diyform_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `cate` int(11) DEFAULT '0',
  `title` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_diypage`;
CREATE TABLE `hs_ewei_shop_diypage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_diypage_menu`;
CREATE TABLE `hs_ewei_shop_diypage_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
  `data` text NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_diypage_plu`;
CREATE TABLE `hs_ewei_shop_diypage_plu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_diypage_template`;
CREATE TABLE `hs_ewei_shop_diypage_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_diypage_template_category`;
CREATE TABLE `hs_ewei_shop_diypage_template_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
  `merch` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_exchange_cart`;
CREATE TABLE `hs_ewei_shop_exchange_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_exchange_code`;
CREATE TABLE `hs_ewei_shop_exchange_code` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_exchange_group`;
CREATE TABLE `hs_ewei_shop_exchange_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_exchange_query`;
CREATE TABLE `hs_ewei_shop_exchange_query` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `openid` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_exchange_record`;
CREATE TABLE `hs_ewei_shop_exchange_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `key` varchar(255) NOT NULL DEFAULT '',
  `uniacid` int(11) DEFAULT NULL,
  `goods` text,
...
DROP TABLE IF EXISTS `hs_ewei_shop_exchange_setting`;
CREATE TABLE `hs_ewei_shop_exchange_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_exhelper_express`;
CREATE TABLE `hs_ewei_shop_exhelper_express` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_exhelper_senduser`;
CREATE TABLE `hs_ewei_shop_exhelper_senduser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_exhelper_sys`;
CREATE TABLE `hs_ewei_shop_exhelper_sys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_express`;
CREATE TABLE `hs_ewei_shop_express` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT '',
...
INSERT INTO `hs_ewei_shop_express` VALUES ('1', '顺丰', 'shunfeng', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('2', '申通', 'shentong', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('3', '韵达快运', 'yunda', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('4', '天天快递', 'tiantian', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('5', '圆通速递', 'yuantong', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('6', '中通速递', 'zhongtong', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('7', 'ems快递', 'ems', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('8', '汇通快运', 'huitongkuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('9', '全峰快递', 'quanfengkuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('10', '宅急送', 'zhaijisong', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('11', 'aae全球专递', 'aae', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('12', '安捷快递', 'anjie', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('13', '安信达快递', 'anxindakuaixi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('14', '彪记快递', 'biaojikuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('15', 'bht', 'bht', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('16', '百福东方国际物流', 'baifudongfang', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('17', '中国东方（COE）', 'coe', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('18', '长宇物流', 'changyuwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('19', '大田物流', 'datianwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('20', '德邦物流', 'debangwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('21', 'dhl', 'dhl', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('22', 'dpex', 'dpex', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('23', 'd速快递', 'dsukuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('24', '递四方', 'disifang', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('25', 'fedex（国外）', 'fedex', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('26', '飞康达物流', 'feikangda', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('27', '凤凰快递', 'fenghuangkuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('28', '飞快达', 'feikuaida', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('29', '国通快递', 'guotongkuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('30', '港中能达物流', 'ganzhongnengda', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('31', '广东邮政物流', 'guangdongyouzhengwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('32', '共速达', 'gongsuda', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('33', '恒路物流', 'hengluwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('34', '华夏龙物流', 'huaxialongwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('35', '海红', 'haihongwangsong', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('36', '海外环球', 'haiwaihuanqiu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('37', '佳怡物流', 'jiayiwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('38', '京广速递', 'jinguangsudikuaijian', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('39', '急先达', 'jixianda', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('40', '佳吉物流', 'jjwl', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('41', '加运美物流', 'jymwl', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('42', '金大物流', 'jindawuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('43', '嘉里大通', 'jialidatong', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('44', '晋越快递', 'jykd', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('45', '快捷速递', 'kuaijiesudi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('46', '联邦快递（国内）', 'lianb', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('47', '联昊通物流', 'lianhaowuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('48', '龙邦物流', 'longbanwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('49', '立即送', 'lijisong', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('50', '乐捷递', 'lejiedi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('51', '民航快递', 'minghangkuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('52', '美国快递', 'meiguokuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('53', '门对门', 'menduimen', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('54', 'OCS', 'ocs', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('55', '配思货运', 'peisihuoyunkuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('56', '全晨快递', 'quanchenkuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('57', '全际通物流', 'quanjitong', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('58', '全日通快递', 'quanritongkuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('59', '全一快递', 'quanyikuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('60', '如风达', 'rufengda', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('61', '三态速递', 'santaisudi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('62', '盛辉物流', 'shenghuiwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('63', '速尔物流', 'sue', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('64', '盛丰物流', 'shengfeng', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('65', '赛澳递', 'saiaodi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('66', '天地华宇', 'tiandihuayu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('67', 'tnt', 'tnt', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('68', 'ups', 'ups', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('69', '万家物流', 'wanjiawuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('70', '文捷航空速递', 'wenjiesudi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('71', '伍圆', 'wuyuan', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('72', '万象物流', 'wxwl', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('73', '新邦物流', 'xinbangwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('74', '信丰物流', 'xinfengwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('75', '亚风速递', 'yafengsudi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('76', '一邦速递', 'yibangwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('77', '优速物流', 'youshuwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('78', '邮政包裹挂号信', 'youzhengguonei', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('79', '邮政国际包裹挂号信', 'youzhengguoji', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('80', '远成物流', 'yuanchengwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('81', '源伟丰快递', 'yuanweifeng', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('82', '元智捷诚快递', 'yuanzhijiecheng', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('83', '运通快递', 'yuntongkuaidi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('84', '越丰物流', 'yuefengwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('85', '源安达', 'yad', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('86', '银捷速递', 'yinjiesudi', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('87', '中铁快运', 'zhongtiekuaiyun', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('88', '中邮物流', 'zhongyouwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('89', '忠信达', 'zhongxinda', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('90', '芝麻开门', 'zhimakaimen', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('91', '安能物流', 'annengwuliu', '1', '0');
INSERT INTO `hs_ewei_shop_express` VALUES ('92', '京东快递', 'jd', '1', '0');

DROP TABLE IF EXISTS `hs_ewei_shop_express_cache`;
CREATE TABLE `hs_ewei_shop_express_cache` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_feedback`;
CREATE TABLE `hs_ewei_shop_feedback` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_form`;
CREATE TABLE `hs_ewei_shop_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_form_category`;
CREATE TABLE `hs_ewei_shop_form_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
DROP TABLE IF EXISTS `hs_ewei_shop_fullback_goods`;
CREATE TABLE `hs_ewei_shop_fullback_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `type` tinyint(3) NOT NULL DEFAULT '0',
  `goodsid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_fullback_log`;
CREATE TABLE `hs_ewei_shop_fullback_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_funbar`;
CREATE TABLE `hs_ewei_shop_funbar` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_gift`;
CREATE TABLE `hs_ewei_shop_gift` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_globonus_bill`;
CREATE TABLE `hs_ewei_shop_globonus_bill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billno` varchar(100) DEFAULT '',
  `paytype` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_globonus_billo`;
CREATE TABLE `hs_ewei_shop_globonus_billo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_globonus_billp`;
CREATE TABLE `hs_ewei_shop_globonus_billp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_globonus_level`;
CREATE TABLE `hs_ewei_shop_globonus_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `levelname` varchar(50) DEFAULT '',
  `bonus` decimal(10,4) DEFAULT '0.0000',
...
DROP TABLE IF EXISTS `hs_ewei_shop_goods`;
CREATE TABLE `hs_ewei_shop_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_goods_comment`;
CREATE TABLE `hs_ewei_shop_goods_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_goods_group`;
CREATE TABLE `hs_ewei_shop_goods_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_goods_label`;
CREATE TABLE `hs_ewei_shop_goods_label` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_goods_labelstyle`;
CREATE TABLE `hs_ewei_shop_goods_labelstyle` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `style` int(3) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED;
DROP TABLE IF EXISTS `hs_ewei_shop_goods_option`;
CREATE TABLE `hs_ewei_shop_goods_option` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_goods_param`;
CREATE TABLE `hs_ewei_shop_goods_param` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_goods_spec`;
CREATE TABLE `hs_ewei_shop_goods_spec` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_goods_spec_item`;
CREATE TABLE `hs_ewei_shop_goods_spec_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `specid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_goodscode_good`;
CREATE TABLE `hs_ewei_shop_goodscode_good` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_groups_adv`;
CREATE TABLE `hs_ewei_shop_groups_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_groups_category`;
CREATE TABLE `hs_ewei_shop_groups_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `thumb` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_groups_goods`;
CREATE TABLE `hs_ewei_shop_groups_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_groups_goods_atlas`;
CREATE TABLE `hs_ewei_shop_groups_goods_atlas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `g_id` int(11) NOT NULL,
  `thumb` varchar(145) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
DROP TABLE IF EXISTS `hs_ewei_shop_groups_order`;
CREATE TABLE `hs_ewei_shop_groups_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_groups_order_refund`;
CREATE TABLE `hs_ewei_shop_groups_order_refund` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_groups_paylog`;
CREATE TABLE `hs_ewei_shop_groups_paylog` (
...
DROP TABLE IF EXISTS `hs_ewei_shop_groups_set`;
CREATE TABLE `hs_ewei_shop_groups_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_groups_verify`;
CREATE TABLE `hs_ewei_shop_groups_verify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(45) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_lottery`;
CREATE TABLE `hs_ewei_shop_lottery` (
...
DROP TABLE IF EXISTS `hs_ewei_shop_lottery_default`;
CREATE TABLE `hs_ewei_shop_lottery_default` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `data` text,
...
DROP TABLE IF EXISTS `hs_ewei_shop_lottery_join`;
CREATE TABLE `hs_ewei_shop_lottery_join` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_lottery_log`;
CREATE TABLE `hs_ewei_shop_lottery_log` (
...
DROP TABLE IF EXISTS `hs_ewei_shop_mc_merchant`;
CREATE TABLE `hs_ewei_shop_mc_merchant` (
  `id` int(11) NOT NULL,
  `uniacid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_member`;
CREATE TABLE `hs_ewei_shop_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_address`;
CREATE TABLE `hs_ewei_shop_member_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '0',
  `realname` varchar(20) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_cart`;
CREATE TABLE `hs_ewei_shop_member_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_favorite`;
CREATE TABLE `hs_ewei_shop_member_favorite` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_group`;
CREATE TABLE `hs_ewei_shop_member_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `groupname` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
DROP TABLE IF EXISTS `hs_ewei_shop_member_history`;
CREATE TABLE `hs_ewei_shop_member_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_level`;
CREATE TABLE `hs_ewei_shop_member_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `level` int(11) DEFAULT '0',
  `levelname` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_log`;
CREATE TABLE `hs_ewei_shop_member_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_message_template`;
CREATE TABLE `hs_ewei_shop_member_message_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
  `template_id` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_message_template_default`;
CREATE TABLE `hs_ewei_shop_member_message_template_default` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_message_template_type`;
CREATE TABLE `hs_ewei_shop_member_message_template_type` (
  `id` int(11) NOT NULL,
...
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('1', '订单付款通知', 'saler_pay', 'OPENTM405584202', 'xldHFTObiLLm7AK544PzW4bFJGgbS0o8Po4cXOgYEis', '订单付款通知', '{{first.DATA}}订单编号：{{keyword1.DATA}}商品名称：{{keyword2.DATA}}商品数量：{{keyword3.DATA}}支付金额：{{keyword4.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('2', '自提订单提交成功通知', 'carrier', 'OPENTM201594720', 'W6-XbT9l2Wb9FUUISss9yVZdPU8iEmEes9IZfvNZnbc', '订单付款通知', '{{first.DATA}}自提码：{{keyword1.DATA}}商品详情：{{keyword2.DATA}}提货地址：{{keyword3.DATA}}提货时间：{{keyword4.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('3', '订单取消通知', 'cancel', 'OPENTM201764653', 'EA6fL2052fvAs7F9w0Dx_UGbVuXmDFqLcrdT4IukWEY', '订单关闭提醒', '{{first.DATA}}订单商品：{{keyword1.DATA}}订单编号：{{keyword2.DATA}}下单时间：{{keyword3.DATA}}订单金额：{{keyword4.DATA}}关闭时间：{{keyword5.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('4', '订单即将取消通知', 'willcancel', 'OPENTM201764653', 'EA6fL2052fvAs7F9w0Dx_UGbVuXmDFqLcrdT4IukWEY', '订单关闭提醒', '{{first.DATA}}订单商品：{{keyword1.DATA}}订单编号：{{keyword2.DATA}}下单时间：{{keyword3.DATA}}订单金额：{{keyword4.DATA}}关闭时间：{{keyword5.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('5', '订单支付成功通知', 'pay', 'OPENTM405584202', 'xldHFTObiLLm7AK544PzW4bFJGgbS0o8Po4cXOgYEis', '订单支付通知', '{{first.DATA}}订单编号：{{keyword1.DATA}}商品名称：{{keyword2.DATA}}商品数量：{{keyword3.DATA}}支付金额：{{keyword4.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('6', '订单发货通知', 'send', 'OPENTM401874827', 'c0Db6XJBYJ0PcdDyDR5YsoGKy6zfvnQrNM97Ml2hBt4', '订单发货通知', '{{first.DATA}}订单编号：{{keyword1.DATA}}快递公司：{{keyword2.DATA}}快递单号：{{keyword3.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('7', '自动发货通知(虚拟物品及卡密)', 'virtualsend', 'OPENTM207793687', 'c2kQ5Pf7QkBUXhAVQRGpRusO1BS2uu_IBjPlIZ7IbYo', '自动发货通知', '{{first.DATA}}商品名称：{{keyword1.DATA}}订单号：{{keyword2.DATA}}订单金额：{{keyword3.DATA}}卡密信息：{{keyword4.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('8', '订单状态更新(修改收货地址)(修改价格)', 'orderstatus', 'TM00017', 'v6w5z7I8FMki08ndnGnfHSyx46eyYq9m_cIZUcvwCgU', '订单付款通知', '{{first.DATA}}订单编号: {{OrderSn.DATA}}订单状态: {{OrderStatus.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('9', '退款成功通知', 'refund1', 'TM00430', 'ez-VqnyVFEX6msJfoegrwMK2qZ6Va02sbOWvaHIMFNw', '退款成功通知', '{{first.DATA}}退款金额：{{orderProductPrice.DATA}}商品详情：{{orderProductName.DATA}}订单编号：{{orderName.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('10', '换货成功通知', 'refund3', 'OPENTM200605630', 'uS1mhnM85BtUum0s5xmlfEhnDGupvYqUkjK0A5o0sb8', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('11', '退款申请驳回通知', 'refund2', 'OPENTM200605630', 'uS1mhnM85BtUum0s5xmlfEhnDGupvYqUkjK0A5o0sb8', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('12', '充值成功通知', 'recharge_ok', 'OPENTM207727673', 'PWycmpCcbBEOuB99kZK6Lb_S_Ve6rZoigooR8lHtRHk', '充值成功提醒', '{{first.DATA}}充值金额：{{keyword1.DATA}}充值时间：{{keyword2.DATA}}账户余额：{{keyword3.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('13', '提现成功通知', 'withdraw_ok', 'OPENTM207422808', 'dpgcRnw1OrF_Beo7kgkK_0ThxcEY3nxpGHUPZ9Q4Yt0', '提现通知', '{{first.DATA}}申请提现金额：{{keyword1.DATA}}取提现手续费：{{keyword2.DATA}}实际到账金额：{{keyword3.DATA}}提现渠道：{{keyword4.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('14', '会员升级通知(任务处理通知)', 'upgrade', 'OPENTM200605630', 'UhLLmFRFoJB21zWe8Ue6s2Wbs6-hwAIcywjXFPEgAfk', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('15', '充值成功通知（后台管理员手动）', 'backrecharge_ok', 'OPENTM207727673', '8cH0W4PS46ttwb0NKaOsWlZXzp68pFkvhmz8Cx1TFYI', '充值成功提醒', '{{first.DATA}}充值金额：{{keyword1.DATA}}充值时间：{{keyword2.DATA}}账户余额：{{keyword3.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('16', '积分变动提醒', 'backpoint_ok', 'OPENTM207509450', 't4X8tcZsZRfiLaxvlZSd9QTgmQTZRpy110DgoJeu4DU', '积分变动提醒', '{{first.DATA}}获得时间：{{keyword1.DATA}}获得积分：{{keyword2.DATA}}获得原因：{{keyword3.DATA}}当前积分：{{keyword4.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('17', '换货发货通知', 'refund4', 'OPENTM401874827', 'c0Db6XJBYJ0PcdDyDR5YsoGKy6zfvnQrNM97Ml2hBt4', '订单发货通知', '{{first.DATA}}订单编号：{{keyword1.DATA}}快递公司：{{keyword2.DATA}}快递单号：{{keyword3.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('18', '砍价活动通知', 'bargain_message', 'OPENTM200605630', null, '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 'bargain', '砍价消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('19', '拼团活动通知', 'groups', null, null, null, null, 'groups', '拼团消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('20', '人人分销通知', 'commission', null, null, null, null, 'commission', '分销消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('21', '商品付款通知', 'saler_goodpay', 'OPENTM200605630', '', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('22', '砍到底价通知', 'bargain_fprice', 'OPENTM200605630', '', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 'bargain', '砍价消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('23', '订单收货通知(卖家)', 'saler_finish', 'OPENTM200605630', '', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('24', '余额兑换成功通知', 'exchange_balance', 'OPENTM207727673', '', '充值成功提醒', '{{first.DATA}}充值金额：{{keyword1.DATA}}充值时间：{{keyword2.DATA}}账户余额：{{keyword3.DATA}}{{remark.DATA}}', 'exchange', '兑换中心消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('25', '积分兑换成功通知', 'exchange_score', 'OPENTM207509450', '', '积分变动提醒', '{{first.DATA}}获得时间：{{keyword1.DATA}}获得积分：{{keyword2.DATA}}获得原因：{{keyword3.DATA}}当前积分：{{keyword4.DATA}}{{remark.DATA}}', 'exchange', '兑换中心消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('26', '兑换中心余额充值通知', 'exchange_recharge', 'OPENTM207727673', '', '充值成功提醒', '{{first.DATA}}充值金额：{{keyword1.DATA}}充值时间：{{keyword2.DATA}}账户余额：{{keyword3.DATA}}{{remark.DATA}}', 'exchange', '兑换中心消息通知', '0');
INSERT INTO `hs_ewei_shop_member_message_template_type` VALUES ('27', '游戏中心通知', 'lottery_get', 'OPENTM200605630', '', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 'lottery', '抽奖消息通知', '0');
DROP TABLE IF EXISTS `hs_ewei_shop_member_printer`;
CREATE TABLE `hs_ewei_shop_member_printer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
  `type` tinyint(3) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_printer_template`;
CREATE TABLE `hs_ewei_shop_member_printer_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
  `type` tinyint(3) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_rank`;
CREATE TABLE `hs_ewei_shop_member_rank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_account`;
CREATE TABLE `hs_ewei_shop_merch_account` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
  `merchid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_adv`;
CREATE TABLE `hs_ewei_shop_merch_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_banner`;
CREATE TABLE `hs_ewei_shop_merch_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `bannername` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_bill`;
CREATE TABLE `hs_ewei_shop_merch_bill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_billo`;
CREATE TABLE `hs_ewei_shop_merch_billo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_category`;
CREATE TABLE `hs_ewei_shop_merch_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `catename` varchar(255) DEFAULT '',
  `createtime` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_category_swipe`;
CREATE TABLE `hs_ewei_shop_merch_category_swipe` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
  `createtime` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_clearing`;
CREATE TABLE `hs_ewei_shop_merch_clearing` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `merchid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_group`;
CREATE TABLE `hs_ewei_shop_merch_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `groupname` varchar(255) DEFAULT '',
  `createtime` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_nav`;
CREATE TABLE `hs_ewei_shop_merch_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_notice`;
CREATE TABLE `hs_ewei_shop_merch_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_perm_log`;
CREATE TABLE `hs_ewei_shop_merch_perm_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_perm_role`;
CREATE TABLE `hs_ewei_shop_merch_perm_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `merchid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_reg`;
CREATE TABLE `hs_ewei_shop_merch_reg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_saler`;
CREATE TABLE `hs_ewei_shop_merch_saler` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `storeid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_store`;
CREATE TABLE `hs_ewei_shop_merch_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_merch_user`;
CREATE TABLE `hs_ewei_shop_merch_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_multi_shop`;
CREATE TABLE `hs_ewei_shop_multi_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `uid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_nav`;
CREATE TABLE `hs_ewei_shop_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `navname` varchar(255) DEFAULT '',
  `icon` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_notice`;
CREATE TABLE `hs_ewei_shop_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_order`;
CREATE TABLE `hs_ewei_shop_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
  `agentid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_order_comment`;
CREATE TABLE `hs_ewei_shop_order_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_order_goods`;
CREATE TABLE `hs_ewei_shop_order_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_order_peerpay`;
CREATE TABLE `hs_ewei_shop_order_peerpay` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `orderid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_order_peerpay_payinfo`;
CREATE TABLE `hs_ewei_shop_order_peerpay_payinfo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_order_refund`;
CREATE TABLE `hs_ewei_shop_order_refund` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_package`;
CREATE TABLE `hs_ewei_shop_package` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
  `price` decimal(10,2) NOT NULL DEFAULT '0.00',
...
DROP TABLE IF EXISTS `hs_ewei_shop_package_goods`;
CREATE TABLE `hs_ewei_shop_package_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `pid` int(11) NOT NULL,
  `goodsid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_package_goods_option`;
CREATE TABLE `hs_ewei_shop_package_goods_option` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `goodsid` int(11) NOT NULL DEFAULT '0',
  `optionid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_perm_log`;
CREATE TABLE `hs_ewei_shop_perm_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_perm_plugin`;
CREATE TABLE `hs_ewei_shop_perm_plugin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_perm_role`;
CREATE TABLE `hs_ewei_shop_perm_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `rolename` varchar(255) DEFAULT '',
  `status` tinyint(3) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_perm_user`;
CREATE TABLE `hs_ewei_shop_perm_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `uid` int(11) DEFAULT '0',
  `username` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_plugin`;
CREATE TABLE `hs_ewei_shop_plugin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `displayorder` int(11) DEFAULT '0',
...
INSERT INTO `hs_ewei_shop_plugin` VALUES ('1', '1', 'qiniu', '七牛存储', '1.0', '官方', '1', 'tool', '../addons/ewei_shopv2/static/images/qiniu.jpg', null, '1', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('2', '2', 'taobao', '商品助手', '1.0', '官方', '1', 'tool', '../addons/ewei_shopv2/static/images/taobao.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('3', '3', 'commission', '人人分销', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/commission.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('4', '4', 'poster', '超级海报', '1.2', '官方', '1', 'sale', '../addons/ewei_shopv2/static/images/poster.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('5', '5', 'verify', 'O2O核销', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/verify.jpg', null, '1', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('6', '6', 'tmessage', '会员群发', '1.0', '官方', '1', 'tool', '../addons/ewei_shopv2/static/images/tmessage.jpg', null, '1', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('7', '7', 'perm', '分权系统', '1.0', '官方', '1', 'help', '../addons/ewei_shopv2/static/images/perm.jpg', null, '1', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('8', '8', 'sale', '营销宝', '1.0', '官方', '1', 'sale', '../addons/ewei_shopv2/static/images/sale.jpg', null, '1', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('9', '9', 'designer', '店铺装修V1', '1.0', '官方', '1', 'help', '../addons/ewei_shopv2/static/images/designer.jpg', null, '0', '1', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('10', '10', 'creditshop', '积分商城', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/creditshop.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('11', '11', 'virtual', '虚拟物品', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/virtual.jpg', null, '1', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('12', '11', 'article', '文章营销', '1.0', '官方', '1', 'help', '../addons/ewei_shopv2/static/images/article.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('13', '13', 'coupon', '超级券', '1.0', '官方', '1', 'sale', '../addons/ewei_shopv2/static/images/coupon.jpg', null, '1', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('14', '14', 'postera', '活动海报', '1.0', '官方', '1', 'sale', '../addons/ewei_shopv2/static/images/postera.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('15', '15', 'system', '系统工具', '1.0', '官方', '0', 'help', '../addons/ewei_shopv2/static/images/system.jpg', null, '0', '1', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('16', '16', 'diyform', '自定表单', '1.0', '官方', '1', 'help', '../addons/ewei_shopv2/static/images/diyform.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('17', '17', 'exhelper', '快递助手', '1.0', '官方', '1', 'help', '../addons/ewei_shopv2/static/images/exhelper.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('18', '18', 'groups', '人人拼团', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/groups.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('19', '19', 'diypage', '店铺装修', '2.0', '官方', '1', 'help', '../addons/ewei_shopv2/static/images/designer.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('20', '20', 'globonus', '全民股东', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/globonus.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('21', '21', 'merch', '多商户', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/merch.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('22', '22', 'qa', '帮助中心', '1.0', '官方', '1', 'help', '../addons/ewei_shopv2/static/images/qa.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('23', '23', 'sms', '短信提醒', '1.0', '官方', '1', 'tool', '../addons/ewei_shopv2/static/images/sms.jpg', '', '1', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('24', '24', 'sign', '积分签到', '1.0', '官方', '1', 'tool', '../addons/ewei_shopv2/static/images/sign.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('25', '25', 'sns', '全民社区', '1.0', '官方', '1', 'sale', '../addons/ewei_shopv2/static/images/sns.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('26', '26', 'wap', '全网通', '1.0', '官方', '1', 'tool', '', '', '1', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('27', '27', 'h5app', 'H5APP', '1.0', '官方', '1', 'tool', '', '', '1', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('28', '28', 'abonus', '区域代理', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/abonus.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('29', '29', 'printer', '小票打印机', '1.0', '官方', '1', 'tool', '', '', '1', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('30', '30', 'bargain', '砍价活动', '1.0', '官方', '1', 'tool', '../addons/ewei_shopv2/static/images/bargain.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('31', '31', 'task', '任务中心', '1.0', '官方', '1', 'sale', '../addons/ewei_shopv2/static/images/task.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('32', '32', 'cashier', '收银台', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/cashier.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('33', '33', 'messages', '消息群发', '1.0', '官方', '1', 'tool', '../addons/ewei_shopv2/static/images/messages.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('34', '34', 'seckill', '整点秒杀', '1.0', '官方', '1', 'sale', '../addons/ewei_shopv2/static/images/seckill.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('35', '35', 'exchange', '兑换中心', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/exchange.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('36', '36', 'lottery', '游戏营销', '1.0', '官方', '1', 'sale', '../addons/ewei_shopv2/static/images/lottery.jpg', '', '0', '0', '0');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('37', '37', 'mmanage', '手机端商家管理中心', '1.0', '官方', '1', 'tool', '../addons/ewei_shopv2/static/images/mmanage.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('38', '38', 'polyapi', '进销存-网店管家', '1.0', '官方', '1', 'tool', '../addons/ewei_shopv2/static/images/polyapi.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('40', '41', 'quick', '快速购买', '1.0', '官方', '1', 'biz', '../addons/ewei_shopv2/static/images/quick.jpg', '', '0', '0', '1');
INSERT INTO `hs_ewei_shop_plugin` VALUES ('41', '44', 'pc', 'PC端', '1.0', '微信魔方', '1', 'tool', '../addons/ewei_shopv2/static/images/pc.jpg', '', '0', '0', '0');


DROP TABLE IF EXISTS `hs_ewei_shop_poster`;
CREATE TABLE `hs_ewei_shop_poster` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `type` tinyint(3) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_poster_log`;
CREATE TABLE `hs_ewei_shop_poster_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_poster_qr`;
CREATE TABLE `hs_ewei_shop_poster_qr` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acid` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_poster_scan`;
CREATE TABLE `hs_ewei_shop_poster_scan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `posterid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_postera`;
CREATE TABLE `hs_ewei_shop_postera` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `type` tinyint(3) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_postera_log`;
CREATE TABLE `hs_ewei_shop_postera_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
  `posterid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_postera_qr`;
CREATE TABLE `hs_ewei_shop_postera_qr` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acid` int(10) unsigned NOT NULL,
  `openid` varchar(100) NOT NULL DEFAULT '',
  `posterid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_qa_adv`;
CREATE TABLE `hs_ewei_shop_qa_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_qa_category`;
CREATE TABLE `hs_ewei_shop_qa_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `thumb` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_qa_question`;
CREATE TABLE `hs_ewei_shop_qa_question` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_qa_set`;
CREATE TABLE `hs_ewei_shop_qa_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_quick`;
CREATE TABLE `hs_ewei_shop_quick` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `title` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_quick_adv`;
CREATE TABLE `hs_ewei_shop_quick_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `merchid` int(11) NOT NULL DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_quick_cart`;
CREATE TABLE `hs_ewei_shop_quick_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `quickid` int(11) NOT NULL DEFAULT '0',
  `openid` varchar(100) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_refund_address`;
CREATE TABLE `hs_ewei_shop_refund_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sale_coupon`;
CREATE TABLE `hs_ewei_shop_sale_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
  `type` tinyint(3) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sale_coupon_data`;
CREATE TABLE `hs_ewei_shop_sale_coupon_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
  `couponid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_saler`;
CREATE TABLE `hs_ewei_shop_saler` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `storeid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_seckill_adv`;
CREATE TABLE `hs_ewei_shop_seckill_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_seckill_category`;
CREATE TABLE `hs_ewei_shop_seckill_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `hs_ewei_shop_seckill_task`;
CREATE TABLE `hs_ewei_shop_seckill_task` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `cateid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_seckill_task_goods`;
CREATE TABLE `hs_ewei_shop_seckill_task_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `taskid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_seckill_task_room`;
CREATE TABLE `hs_ewei_shop_seckill_task_room` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `taskid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_seckill_task_time`;
CREATE TABLE `hs_ewei_shop_seckill_task_time` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `taskid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sign_records`;
CREATE TABLE `hs_ewei_shop_sign_records` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `time` int(11) NOT NULL DEFAULT '0',
  `openid` varchar(50) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sign_set`;
CREATE TABLE `hs_ewei_shop_sign_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sign_user`;
CREATE TABLE `hs_ewei_shop_sign_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `openid` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sms`;
CREATE TABLE `hs_ewei_shop_sms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sms_set`;
CREATE TABLE `hs_ewei_shop_sms_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_adv`;
CREATE TABLE `hs_ewei_shop_sns_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_board`;
CREATE TABLE `hs_ewei_shop_sns_board` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `cid` int(11) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_board_follow`;
CREATE TABLE `hs_ewei_shop_sns_board_follow` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_category`;
CREATE TABLE `hs_ewei_shop_sns_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `thumb` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_complain`;
CREATE TABLE `hs_ewei_shop_sns_complain` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_complaincate`;
CREATE TABLE `hs_ewei_shop_sns_complaincate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_level`;
CREATE TABLE `hs_ewei_shop_sns_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_like`;
CREATE TABLE `hs_ewei_shop_sns_like` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_manage`;
CREATE TABLE `hs_ewei_shop_sns_manage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `bid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_member`;
CREATE TABLE `hs_ewei_shop_sns_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT NULL,
  `level` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sns_post`;
CREATE TABLE `hs_ewei_shop_sns_post` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `bid` int(11) DEFAULT '0',
  `pid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_store`;
CREATE TABLE `hs_ewei_shop_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `storename` varchar(255) DEFAULT '',
  `address` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_sysset`;
CREATE TABLE `hs_ewei_shop_sysset` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `sets` longtext,
  `plugins` longtext,
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_adv`;
CREATE TABLE `hs_ewei_shop_system_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `thumb` varchar(255) DEFAULT '',
  `url` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_article`;
CREATE TABLE `hs_ewei_shop_system_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_banner`;
CREATE TABLE `hs_ewei_shop_system_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `thumb` varchar(255) DEFAULT '',
  `url` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_case`;
CREATE TABLE `hs_ewei_shop_system_case` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `thumb` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_casecategory`;
CREATE TABLE `hs_ewei_shop_system_casecategory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT '',
  `displayorder` int(11) DEFAULT '0',
  `status` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_category`;
CREATE TABLE `hs_ewei_shop_system_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT '',
  `displayorder` int(11) DEFAULT '0',
  `status` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_company_article`;
CREATE TABLE `hs_ewei_shop_system_company_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `author` varchar(255) DEFAULT '',
  `thumb` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_company_category`;
CREATE TABLE `hs_ewei_shop_system_company_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT '',
  `displayorder` int(11) DEFAULT '0',
  `status` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_copyright`;
CREATE TABLE `hs_ewei_shop_system_copyright` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
  `copyright` text,
  `bgcolor` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_copyright_notice`;
CREATE TABLE `hs_ewei_shop_system_copyright_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `author` varchar(255) DEFAULT '',
  `content` text,
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_guestbook`;
CREATE TABLE `hs_ewei_shop_system_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT '',
  `content` varchar(255) NOT NULL DEFAULT '',
  `nickname` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_link`;
CREATE TABLE `hs_ewei_shop_system_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_setting`;
CREATE TABLE `hs_ewei_shop_system_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_system_site`;
CREATE TABLE `hs_ewei_shop_system_site` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `type` varchar(32) NOT NULL DEFAULT '',
  `content` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
DROP TABLE IF EXISTS `hs_ewei_shop_task_adv`;
CREATE TABLE `hs_ewei_shop_task_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_task_default`;
CREATE TABLE `hs_ewei_shop_task_default` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `data` text,
  `addtime` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_task_join`;
CREATE TABLE `hs_ewei_shop_task_join` (
...
DROP TABLE IF EXISTS `hs_ewei_shop_task_joiner`;
CREATE TABLE `hs_ewei_shop_task_joiner` (
...
DROP TABLE IF EXISTS `hs_ewei_shop_task_log`;
CREATE TABLE `hs_ewei_shop_task_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `openid` varchar(100) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_task_poster`;
CREATE TABLE `hs_ewei_shop_task_poster` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_task_poster_qr`;
CREATE TABLE `hs_ewei_shop_task_poster_qr` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_virtual_category`;
CREATE TABLE `hs_ewei_shop_virtual_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `merchid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_virtual_data`;
CREATE TABLE `hs_ewei_shop_virtual_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `typeid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_virtual_type`;
CREATE TABLE `hs_ewei_shop_virtual_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `cate` int(11) DEFAULT '0',
  `title` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_wxcard`;
CREATE TABLE `hs_ewei_shop_wxcard` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_pc_adv`;
CREATE TABLE IF NOT EXISTS `hs_ewei_shop_pc_adv` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_pc_link`;
CREATE TABLE IF NOT EXISTS `hs_ewei_shop_pc_link` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_pc_menu`;
CREATE TABLE IF NOT EXISTS `hs_ewei_shop_pc_menu` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `hs_ewei_shop_pc_slide`;
CREATE TABLE IF NOT EXISTS `hs_ewei_shop_pc_slide` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_member_mergelog`;
CREATE TABLE `hs_ewei_shop_member_mergelog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_payment`;
CREATE TABLE `hs_ewei_shop_payment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_polyapi_key`;
CREATE TABLE `hs_ewei_shop_polyapi_key` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `merchid` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hs_ewei_shop_task`;
CREATE TABLE `hs_ewei_shop_task` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `title` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `hs_ewei_shop_task_extension`;
CREATE TABLE `hs_ewei_shop_task_extension` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hs_ewei_shop_task_extension_join`;
CREATE TABLE `hs_ewei_shop_task_extension_join` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `title` varchar(255) NOT NULL DEFAULT '',
  `uid` int(11) NOT NULL,
...
INSERT INTO `hs_ewei_shop_express` VALUES ('1', '顺丰', 'shunfeng', '1', '0', 'JH_014');
INSERT INTO `hs_ewei_shop_express` VALUES ('2', '申通', 'shentong', '1', '0', 'JH_005');
INSERT INTO `hs_ewei_shop_express` VALUES ('3', '韵达快运', 'yunda', '1', '0', 'JH_003');
INSERT INTO `hs_ewei_shop_express` VALUES ('4', '天天快递', 'tiantian', '1', '0', 'JH_004');
INSERT INTO `hs_ewei_shop_express` VALUES ('5', '圆通速递', 'yuantong', '1', '0', 'JH_002');
INSERT INTO `hs_ewei_shop_express` VALUES ('6', '中通速递', 'zhongtong', '1', '0', 'JH_006');
INSERT INTO `hs_ewei_shop_express` VALUES ('7', 'ems快递', 'ems', '1', '0', 'JH_001');
INSERT INTO `hs_ewei_shop_express` VALUES ('8', '百世汇通', 'huitongkuaidi', '1', '0', 'JH_012');
INSERT INTO `hs_ewei_shop_express` VALUES ('9', '全峰快递', 'quanfengkuaidi', '1', '0', 'JH_009');
INSERT INTO `hs_ewei_shop_express` VALUES ('10', '宅急送', 'zhaijisong', '1', '0', 'JH_007');
INSERT INTO `hs_ewei_shop_express` VALUES ('11', 'aae全球专递', 'aae', '1', '0', 'JHI_049');
INSERT INTO `hs_ewei_shop_express` VALUES ('12', '安捷快递', 'anjie', '1', '0', '');
INSERT INTO `hs_ewei_shop_express` VALUES ('13', '安信达快递', 'anxindakuaixi', '1', '0', 'JH_131');
INSERT INTO `hs_ewei_shop_express` VALUES ('14', '彪记快递', 'biaojikuaidi', '1', '0', '');
INSERT INTO `hs_ewei_shop_express` VALUES ('15', 'bht', 'bht', '1', '0', 'JHI_008');
INSERT INTO `hs_ewei_shop_express` VALUES ('16', '百福东方国际物流', 'baifudongfang', '1', '0', 'JH_062');
INSERT INTO `hs_ewei_shop_express` VALUES ('17', '中国东方（COE）', 'coe', '1', '0', 'JHI_038');
INSERT INTO `hs_ewei_shop_express` VALUES ('18', '长宇物流', 'changyuwuliu', '1', '0', '');
INSERT INTO `hs_ewei_shop_express` VALUES ('19', '大田物流', 'datianwuliu', '1', '0', 'JH_050');
INSERT INTO `hs_ewei_shop_express` VALUES ('20', '德邦物流', 'debangwuliu', '1', '0', 'JH_011');
INSERT INTO `hs_ewei_shop_express` VALUES ('21', 'dhl', 'dhl', '1', '0', 'JHI_002');
INSERT INTO `hs_ewei_shop_express` VALUES ('22', 'dpex', 'dpex', '1', '0', 'JHI_011');
INSERT INTO `hs_ewei_shop_express` VALUES ('23', 'd速快递', 'dsukuaidi', '1', '0', 'JH_049');
INSERT INTO `hs_ewei_shop_express` VALUES ('24', '递四方', 'disifang', '1', '0', 'JHI_080');
INSERT INTO `hs_ewei_shop_express` VALUES ('25', 'fedex（国外）', 'fedex', '1', '0', 'JHI_014');
INSERT INTO `hs_ewei_shop_express` VALUES ('26', '飞康达物流', 'feikangda', '1', '0', 'JH_088');
INSERT INTO `hs_ewei_shop_express` VALUES ('27', '凤凰快递', 'fenghuangkuaidi', '1', '0', '');
INSERT INTO `hs_ewei_shop_express` VALUES ('28', '飞快达', 'feikuaida', '1', '0', 'JH_151');
INSERT INTO `hs_ewei_shop_express` VALUES ('29', '国通快递', 'guotongkuaidi', '1', '0', 'JH_010');
INSERT INTO `hs_ewei_shop_express` VALUES ('30', '港中能达物流', 'ganzhongnengda', '1', '0', 'JH_033');
INSERT INTO `hs_ewei_shop_express` VALUES ('31', '广东邮政物流', 'guangdongyouzhengwuliu', '1', '0', 'JH_135');
INSERT INTO `hs_ewei_shop_express` VALUES ('32', '共速达', 'gongsuda', '1', '0', 'JH_039');
INSERT INTO `hs_ewei_shop_express` VALUES ('33', '恒路物流', 'hengluwuliu', '1', '0', 'JH_048');
INSERT INTO `hs_ewei_shop_express` VALUES ('34', '华夏龙物流', 'huaxialongwuliu', '1', '0', 'JH_129');
INSERT INTO `hs_ewei_shop_express` VALUES ('35', '海红', 'haihongwangsong', '1', '0', 'JH_132');
INSERT INTO `hs_ewei_shop_express` VALUES ('36', '海外环球', 'haiwaihuanqiu', '1', '0', 'JHI_013');
INSERT INTO `hs_ewei_shop_express` VALUES ('37', '佳怡物流', 'jiayiwuliu', '1', '0', 'JH_035');
INSERT INTO `hs_ewei_shop_express` VALUES ('38', '京广速递', 'jinguangsudikuaijian', '1', '0', 'JH_041');
INSERT INTO `hs_ewei_shop_express` VALUES ('39', '急先达', 'jixianda', '1', '0', 'JH_040');
INSERT INTO `hs_ewei_shop_express` VALUES ('40', '佳吉物流', 'jiajiwuliu', '1', '0', 'JH_030');
INSERT INTO `hs_ewei_shop_express` VALUES ('41', '加运美物流', 'jymwl', '1', '0', 'JH_054');
INSERT INTO `hs_ewei_shop_express` VALUES ('42', '金大物流', 'jindawuliu', '1', '0', 'JH_079');
INSERT INTO `hs_ewei_shop_express` VALUES ('43', '嘉里大通', 'jialidatong', '1', '0', 'JH_060');
INSERT INTO `hs_ewei_shop_express` VALUES ('44', '晋越快递', 'jykd', '1', '0', 'JHI_046');
INSERT INTO `hs_ewei_shop_express` VALUES ('45', '快捷速递', 'kuaijiesudi', '1', '0', 'JH_008');
INSERT INTO `hs_ewei_shop_express` VALUES ('46', '联邦快递（国内）', 'lianb', '1', '0', 'JH_122');
INSERT INTO `hs_ewei_shop_express` VALUES ('47', '联昊通物流', 'lianhaowuliu', '1', '0', 'JH_021');
INSERT INTO `hs_ewei_shop_express` VALUES ('48', '龙邦物流', 'longbanwuliu', '1', '0', 'JH_019');
INSERT INTO `hs_ewei_shop_express` VALUES ('49', '立即送', 'lijisong', '1', '0', 'JH_044');
INSERT INTO `hs_ewei_shop_express` VALUES ('50', '乐捷递', 'lejiedi', '1', '0', 'JH_043');
INSERT INTO `hs_ewei_shop_express` VALUES ('51', '民航快递', 'minghangkuaidi', '1', '0', 'JH_100');
INSERT INTO `hs_ewei_shop_express` VALUES ('52', '美国快递', 'meiguokuaidi', '1', '0', 'JHI_044');
INSERT INTO `hs_ewei_shop_express` VALUES ('53', '门对门', 'menduimen', '1', '0', 'JH_036');
INSERT INTO `hs_ewei_shop_express` VALUES ('54', 'OCS', 'ocs', '1', '0', 'JHI_012');
INSERT INTO `hs_ewei_shop_express` VALUES ('55', '配思货运', 'peisihuoyunkuaidi', '1', '0', '');
INSERT INTO `hs_ewei_shop_express` VALUES ('56', '全晨快递', 'quanchenkuaidi', '1', '0', 'JH_055');
INSERT INTO `hs_ewei_shop_express` VALUES ('57', '全际通物流', 'quanjitong', '1', '0', 'JH_127');
INSERT INTO `hs_ewei_shop_express` VALUES ('58', '全日通快递', 'quanritongkuaidi', '1', '0', 'JH_029');
INSERT INTO `hs_ewei_shop_express` VALUES ('59', '全一快递', 'quanyikuaidi', '1', '0', 'JH_020');
INSERT INTO `hs_ewei_shop_express` VALUES ('60', '如风达', 'rufengda', '1', '0', 'JH_017');
INSERT INTO `hs_ewei_shop_express` VALUES ('61', '三态速递', 'santaisudi', '1', '0', 'JH_065');
INSERT INTO `hs_ewei_shop_express` VALUES ('62', '盛辉物流', 'shenghuiwuliu', '1', '0', 'JH_066');
INSERT INTO `hs_ewei_shop_express` VALUES ('63', '速尔物流', 'sue', '1', '0', 'JH_016');
INSERT INTO `hs_ewei_shop_express` VALUES ('64', '盛丰物流', 'shengfeng', '1', '0', 'JH_082');
INSERT INTO `hs_ewei_shop_express` VALUES ('65', '赛澳递', 'saiaodi', '1', '0', 'JH_042');
INSERT INTO `hs_ewei_shop_express` VALUES ('66', '天地华宇', 'tiandihuayu', '1', '0', 'JH_018');
INSERT INTO `hs_ewei_shop_express` VALUES ('67', 'tnt', 'tnt', '1', '0', 'JHI_003');
INSERT INTO `hs_ewei_shop_express` VALUES ('68', 'ups', 'ups', '1', '0', 'JHI_004');
INSERT INTO `hs_ewei_shop_express` VALUES ('69', '万家物流', 'wanjiawuliu', '1', '0', '');
INSERT INTO `hs_ewei_shop_express` VALUES ('70', '文捷航空速递', 'wenjiesudi', '1', '0', '');
INSERT INTO `hs_ewei_shop_express` VALUES ('71', '伍圆', 'wuyuan', '1', '0', '');
INSERT INTO `hs_ewei_shop_express` VALUES ('72', '万象物流', 'wxwl', '1', '0', 'JH_115');
INSERT INTO `hs_ewei_shop_express` VALUES ('73', '新邦物流', 'xinbangwuliu', '1', '0', 'JH_022');
INSERT INTO `hs_ewei_shop_express` VALUES ('74', '信丰物流', 'xinfengwuliu', '1', '0', 'JH_023');
INSERT INTO `hs_ewei_shop_express` VALUES ('75', '亚风速递', 'yafengsudi', '1', '0', 'JH_075');
INSERT INTO `hs_ewei_shop_express` VALUES ('76', '一邦速递', 'yibangwuliu', '1', '0', 'JH_064');
INSERT INTO `hs_ewei_shop_express` VALUES ('77', '优速物流', 'youshuwuliu', '1', '0', 'JH_013');
INSERT INTO `hs_ewei_shop_express` VALUES ('78', '邮政快递包裹', 'youzhengguonei', '1', '0', 'JH_077');
INSERT INTO `hs_ewei_shop_express` VALUES ('79', '邮政国际包裹挂号信', 'youzhengguoji', '1', '0', '');
INSERT INTO `hs_ewei_shop_express` VALUES ('80', '远成物流', 'yuanchengwuliu', '1', '0', 'JH_024');
INSERT INTO `hs_ewei_shop_express` VALUES ('81', '源伟丰快递', 'yuanweifeng', '1', '0', 'JH_141');
INSERT INTO `hs_ewei_shop_express` VALUES ('82', '元智捷诚快递', 'yuanzhijiecheng', '1', '0', 'JH_126');
INSERT INTO `hs_ewei_shop_express` VALUES ('83', '运通快递', 'yuntongkuaidi', '1', '0', 'JH_145');
INSERT INTO `hs_ewei_shop_express` VALUES ('84', '越丰物流', 'yuefengwuliu', '1', '0', 'JH_068');
INSERT INTO `hs_ewei_shop_express` VALUES ('85', '源安达', 'yad', '1', '0', 'JH_067');
INSERT INTO `hs_ewei_shop_express` VALUES ('86', '银捷速递', 'yinjiesudi', '1', '0', 'JH_148');
INSERT INTO `hs_ewei_shop_express` VALUES ('87', '中铁快运', 'zhongtiekuaiyun', '1', '0', 'JH_015');
INSERT INTO `hs_ewei_shop_express` VALUES ('88', '中邮物流', 'zhongyouwuliu', '1', '0', 'JH_027');
INSERT INTO `hs_ewei_shop_express` VALUES ('89', '忠信达', 'zhongxinda', '1', '0', 'JH_086');
INSERT INTO `hs_ewei_shop_express` VALUES ('90', '芝麻开门', 'zhimakaimen', '1', '0', 'JH_026');
INSERT INTO `hs_ewei_shop_express` VALUES ('91', '安能物流', 'annengwuliu', '1', '0', 'JH_059');
INSERT INTO `hs_ewei_shop_express` VALUES ('92', '京东快递', 'jd', '1', '0', 'JH_046');
