...
CREATE TABLE `ims_ewei_shop_article` (
  ...
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='营销文章';
...
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='营销表单分类';
...
CREATE TABLE `ims_ewei_shop_article_log` (
  ...
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=2593 DEFAULT CHARSET=utf8 COMMENT='点赞/阅读记录';
...
CREATE TABLE `ims_ewei_shop_article_share` (
  ...
  KEY `idx_aid` (`aid`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=595 DEFAULT CHARSET=utf8 COMMENT='用户分享数据';
...
) ENGINE=MyISAM AUTO_INCREMENT=7838 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_goods_option` (
  ...
  KEY `idx_goodsid` (`goodsid`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM AUTO_INCREMENT=162140 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_goods_param` (
  ...
  KEY `idx_goodsid` (`goodsid`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM AUTO_INCREMENT=106370 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_goods_spec` (
  ...
  KEY `idx_goodsid` (`goodsid`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM AUTO_INCREMENT=9919 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_goods_spec_item` (
  ...
  KEY `idx_show` (`show`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM AUTO_INCREMENT=59604 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_member` (
  ...
  KEY `idx_level` (`level`)
) ENGINE=MyISAM AUTO_INCREMENT=13051 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_member_history` (
  ...
  KEY `idx_deleted` (`deleted`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM AUTO_INCREMENT=11895 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=37258 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_virtual_data` (
  ...
  KEY `idx_orderid` (`orderid`)
) ENGINE=MyISAM AUTO_INCREMENT=17460 DEFAULT CHARSET=utf8;
