...
CREATE TABLE `ims_ewei_shop_article` (
  ...
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='营销文章';
...
CREATE TABLE `ims_ewei_shop_article_log` (
  ...
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=2550 DEFAULT CHARSET=utf8 COMMENT='点赞/阅读记录';
...
CREATE TABLE `ims_ewei_shop_article_share` (
  ...
  KEY `idx_aid` (`aid`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=594 DEFAULT CHARSET=utf8 COMMENT='用户分享数据';
...
) ENGINE=MyISAM AUTO_INCREMENT=6971 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_goods_option` (
  ...
  KEY `idx_goodsid` (`goodsid`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM AUTO_INCREMENT=145056 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_goods_param` (
  ...
  KEY `idx_goodsid` (`goodsid`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM AUTO_INCREMENT=90234 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_goods_spec` (
  ...
  KEY `idx_goodsid` (`goodsid`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM AUTO_INCREMENT=8606 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_goods_spec_item` (
  ...
  KEY `idx_show` (`show`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM AUTO_INCREMENT=53362 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_member` (
  ...
  KEY `idx_level` (`level`)
) ENGINE=MyISAM AUTO_INCREMENT=12718 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_member_history` (
  ...
  KEY `idx_deleted` (`deleted`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM AUTO_INCREMENT=11185 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=34713 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=3783 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_virtual_data` (
  ...
  KEY `idx_orderid` (`orderid`)
) ENGINE=MyISAM AUTO_INCREMENT=16209 DEFAULT CHARSET=utf8;
...
(4, 5, 'verify', 'O2O核销', '1.0', '官方', 1, 'biz', '../addons/ewei_shopv2/static/images/verify.jpg', NULL, 1, 0, 0),
(5, 6, 'tmessage', '会员群发', '1.0', '官方', 1, 'tool', '../addons/ewei_shopv2/static/images/tmessage.jpg', NULL, 1, 0, 0),
(6, 4, 'poster', '超级海报', '1.2', '官方', 1, 'sale', '../addons/ewei_shopv2/static/images/poster.jpg', '', 0, 0, 0),
...
(9, 9, 'designer', '店铺装修', '1.0', '官方', 0, 'help', '../addons/ewei_shopv2/static/images/designer.jpg', NULL, 0, 1, 0),
...
(23, 29, 'sign', '积分签到', '1.0', '官方', 1, 'tool', '../addons/ewei_shopv2/static/images/sign.jpg', '', 0, 0, 1);
