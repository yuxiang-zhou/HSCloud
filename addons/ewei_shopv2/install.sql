...
CREATE TABLE `hs_ewei_shop_article_log` (
  ...
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='点赞/阅读记录';
...
) ENGINE=MyISAM AUTO_INCREMENT=2636 DEFAULT CHARSET=utf8;
